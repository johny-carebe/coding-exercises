...
describe Puppies do
  describe '.parse' do
    ...
    it {
      is_expected.to match_array %w[paws/dogs/8311 paws/dogs/8318 paws/dogs/8316 paws/dogs/8317
                                    paws/dogs/8322 paws/dogs/8337 paws/dogs/8339 paws/dogs/8341]
    }

    xit 'contains the first link' do
      # all_dog_links.first.attributes['href'].value
      is_expected.to include 'paws/dogs/121'
    end

    xit 'contains a lot of links' do
